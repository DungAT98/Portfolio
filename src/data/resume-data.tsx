  ...
  projects: [
    {
      ...
      description: "A web application that helps users to create invoice to claim their money. It used the sharepoint workflow to do the business process. The application is built with Sharepoint Framework and deployed on Sharepoint Server Subscription Edition."
    },
    {
      ...
      description: "A web application that helps users to setup automation tasks for their business. The process will depends on data in Microsoft Dynamics 365 and do the workflows. The application is built with a microservices architecture and deployed on Azure. It uses Azure DevOps for CI/CD pipelines."
    },
    {
      ...
      description: "A landing website that helps users to know about the company and the services. The application is built with Gatsby and deployed on Azure. It uses Azure DevOps for CI/CD pipelines."
    },
    {
      title: "Candi Portal",
      techStack: [
      ...
      description: "A portal to help users to visualize the electrical data in each sites. For the long running process, it uses Azure Durable Functions to do the job. The application is built with Blazor WebAssembly and deployed on Azure",
    },
    {
      title: "Paymaya",
      techStack: [
      ...
      description: "A azure function to do the ETL process from excel file to Microsoft Dynamics 365. The application is built with Azure Functions and deployed on Azure."
    }
  ]
} as const;
